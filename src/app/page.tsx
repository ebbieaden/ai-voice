...
export default function Home() {
  ...
  // Now for the other API call to create the sound recording
  ...
  return (
    <main className="flex min-h-screen bg-white-900 flex-col items-center justify-between px-24 py-12">
      <h1 className=" text-5x1 mb-4">FakeVoice</h1>
      <div className="mb-4">
        This is a project that uses the ElevenLabs API to convert your text into a speech dictated by a fake, AI-Generated voice
      </div>
      <div className="w-full items-counter flex flex-col gap-2 mt-2">
        ...
        <button className="bg-blue-600 px-5 mt-2 py-1 self-center h-max rounded-sm hover:bg-blue-900 disabled:cursor-not-allowed disabled:bg-blue-900 transition-colors"
      ...
      <div className="w-80 h-80 mt-12 relative placeholder">
        {theAudio && (
